...
\usepackage{silence}
\WarningFilter[wrongstypath]{latex}{You have requested package }
\ActivateWarningFilters[wrongstypath]
\usepackage{extra_pkg/tkz-kiviat} % Kiviat diagrams
\DeactivateWarningFilters[wrongstypath]
